function [path, StartTree, GoalTree, iter, startNode_in_constraints, goalNode_in_constraints] = BiRRT(RRT_structure, truss, maxIter, wayPoint)
tic;
...
disp('RRT planning...');
startNode_in_constraints = [];
goalNode_in_constraints = [];
while(1)
    %% Start Tree
