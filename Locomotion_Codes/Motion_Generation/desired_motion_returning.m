function [dx_temp, equal_const, inequal_const, constraint_flag] = desired_motion_returning(D,n,R,C,M,x,dt,rotate_node,front_node,back_node,pos_foot_node,data,x_fin)
...
%% Objective Function
% This should be changed tomorrow
% fun = @(dx) min_altitude_cal(x,dx,dt,rotate_node,front_node,back_node);
fun = @(dx) distance_from_x_fin(x,dx,x_fin);
